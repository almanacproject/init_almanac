server:
  applicationConnectors:
    - type: https
      port: 8443
      bindHost: 0.0.0.0
      keyStorePath: /opt/keypass/conf/ampap.keystore.jks
      keyStorePassword: '$${bob.ampap.password}'
      keyStoreType: JKS
      trustStorePath: /opt/keypass/conf/ampap.truststore.jks
      trustStorePassword: '$${bob.ampap.password}'
      trustStoreType: JKS
      validateCerts: true
      validatePeers: true
